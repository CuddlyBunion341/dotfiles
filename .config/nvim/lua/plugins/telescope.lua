return {
  ...
  keys = {
    ...
    {
      "<leader>as",
      "<cmd>Telescope find_files prompt_title=Services cwd=app/services/ hidden=true<cr>",
      desc = "Find Rails services",
    },
    {
      "<leader>ah",
      "<cmd>Telescope find_files prompt_title=Helpers cwd=app/helpers/ hidden=true<cr>",
      desc = "Find Rails helpers",
    },
    {
      "<leader>am",
      "<cmd>Telescope find_files prompt_title=Models cwd=app/models/ hidden=true<cr>",
      desc = "Find Rails models",
    },
    {
      "<leader>at",
      "<cmd>Telescope find_files prompt_title=Specs cwd=spec/ hidden=true<cr>",
      desc = "Find Rails specs",
    },
    {
      "<leader>af",
      "<cmd>Telescope find_files prompt_title=Specs cwd=spec/factories hidden=true<cr>",
      desc = "Find Rails factories",
    },
    {
      "<leader>av",
